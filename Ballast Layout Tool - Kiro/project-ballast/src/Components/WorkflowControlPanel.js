  ...
  const steps = [
    {
      ...
      description: "Auto-detect from address or draw manually",
    },
    {
      id: "building-edit",
      label: "Edit Building Outline",
      description: "Drag points to adjust your outline",
    },
    {
      id: "obstructions",
      label: "Draw Obstructions",
      description: "Mark vents, skylights, and HVAC units",
    },
    {
      id: "obstructions-edit",
      label: "Edit Obstructions",
      description: "Drag points to adjust obstruction shapes",
    },
    {
      id: "arrays",
      label: "Create Panel Arrays",
      description: "Click and drag to place solar panels",
    },
  ];
  ...
  return (
    ...
    >
      ...
      {currentStep === "building" && (
        ...
        >
          🌞 Use auto-detect above or click on the map to draw manually
        </div>
      )}
      ...
      {currentStep === "obstructions-edit" && (
        ...
        >
          💡 Tip: Drag the points on obstruction outlines to fine-tune their
          shapes
        </div>
      )}
    </div>
